package com.github.astah.plugin.updater;
...
import com.github.astah.plugin.updater.NotificationPopup.Position;
...
public class AutoUpdater {
	...
	public void check() throws IOException {
		if (updateXml == null || updateXml.equals("")) {
			throw new IOException("update.xml must be set.");
		}
